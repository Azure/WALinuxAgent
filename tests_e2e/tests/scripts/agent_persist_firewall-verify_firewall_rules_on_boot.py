...
def verify_wireserver_ip_reachable_for_root(firewall_manager: FirewallManager):
    """
    For root logs -
    ...
    firewall_manager.log_firewall_state("** Current state of the firewall")
...
def verify_wireserver_ip_unreachable_for_non_root(firewall_manager: FirewallManager):
    """
    For non-root -
...
def verify_tcp_connection_to_wireserver_for_non_root(firewall_manager: FirewallManager):
    """
    For non-root -
...
def main():
    try:
        ...
        verify_wireserver_ip_unreachable_for_non_root(firewall_manager)
        verify_wireserver_ip_reachable_for_root(firewall_manager)
        verify_tcp_connection_to_wireserver_for_non_root(firewall_manager)
    finally:
