...
class RsmUpdateBvt(AgentVmTest):
    ...
    def run(self) -> None:
        ...
        request_rsm_update(self._downgrade_version, self._context.vm, arch_type, True)
        ...
        request_rsm_update(upgrade_version, self._context.vm, arch_type, False)
        ...
        request_rsm_update(current_version, self._context.vm, arch_type, False)
        ...
        request_rsm_update(version, self._context.vm, arch_type, True)
