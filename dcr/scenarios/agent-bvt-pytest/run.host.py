...
if __name__ == '__main__':
    ...
    stdout, stderr = execute_command_and_raise_on_error('ssh -o StrictHostKeyChecking=no {0}@{1} "sudo bash /home/{0}/dcr/scripts/run_pytest.sh /home/{0}/test_results {2}"'.format(username, host, pypy_path), shell=True)
