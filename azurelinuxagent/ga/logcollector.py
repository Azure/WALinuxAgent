...
EXPECTED_CGROUP_CHECK_ERRCODE = 4

LOG_COLLECTOR_EXPECTED_CGROUP_CHECK_MAX_RETRIES = 3
LOG_COLLECTOR_EXPECTED_CGROUP_CHECK_RETRY_DELAY = 10
LOG_COLLECTOR_EXPECTED_CGROUP_CHECK_MAX_FAILURES = 3
