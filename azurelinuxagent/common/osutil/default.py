...
# this rule was used <= 2.2.26.  This rule helped to validate our change, and detemine impact.
...
class DefaultOSUtil(object):
    ...
    def remove_firewall(self, dst_ip=None, uid=None):
        ...
        try:
            ...
            # This rule was <= 2.2.26 only, and may still exist on some VMs.  Until 2.2.26
