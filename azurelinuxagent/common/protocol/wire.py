    ...
    def try_update_goal_state(self):
        ...
        try:
            ...
            if not self._last_try_update_goal_state_failed:
                ...
                message = u"An error occurred while retrieving the goal state: {0}".format(textutil.format_exception())
                logger.warn(message)
    ...
    def report_event(self, events_iterator):
        ...
        for event in events_iterator:
            try:
                ...
                logger.warn("Unexpected error when generating Events: {0}, {1}", ustr(error), textutil.format_exception())
