...
class TestProvision(AgentTestCase):
    ...
    @patch('azurelinuxagent.common.osutil.default.DefaultOSUtil.get_instance_id',
           return_value='B9F3C233-9913-9F42-8EB3-BA656DF32502')
    def test_eject_dvd_provisioned_not_signaled_signaling_complete(self, mock_util):
        ...
        ph.is_provisioned = Mock(return_value="provisioned_not_signaled")
    ...
    @patch('azurelinuxagent.common.osutil.default.DefaultOSUtil.get_instance_id',
           return_value='B9F3C233-9913-9F42-8EB3-BA656DF32502')
    def test_eject_dvd_provisioned_not_signaled_signaling_incomplete(self, mock_util):
    ...
    @patch('azurelinuxagent.common.osutil.default.DefaultOSUtil.get_instance_id',
           return_value='B9F3C233-9913-9F42-8EB3-BA656DF32502')
    def test_eject_not_provisioned_signaling_complete(self,
                                                      mock_util, distro_name, distro_version, distro_full_name):
        ...
        ph.write_provisioned = Mock()
        ph.osutil.eject_dvd = Mock()
        ph.reg_ssh_host_key = Mock(return_value="")
        ph.is_provisioned = Mock(return_value="not_provisioned")
    ...
    @patch('azurelinuxagent.common.osutil.default.DefaultOSUtil.get_instance_id',
           return_value='B9F3C233-9913-9F42-8EB3-BA656DF32502')
    def test_eject_not_provisioned_signaling_incomplete(self, mock_util, distro_name, distro_version, distro_full_name):
        provision_handler = get_provision_handler(distro_name, distro_version,
                                                  distro_full_name)
        ph = get_provision_handler(distro_name, distro_version,
                                   distro_full_name)
    ...
    def test_is_provisioned_is_provisioned_not_signaled(self,
        ...
        ph.write_provisioned = Mock()
        ph.write_signaled = Mock()
        ph.isfile_provisioned = Mock()
        ph.isfile_signaled = Mock(return_value=False)
    ...
    @patch('azurelinuxagent.common.utils.fileutil.read_file',
           return_value="B9F3C233-9913-9F42-8EB3-BA656DF32502")
    @patch('azurelinuxagent.pa.deprovision.get_deprovision_handler')
    def test_is_provisioned_not_deprovisioned_signaled(self,
                                              mock_deprovision, mock_read, mock_isfile):
    ...
    @patch('azurelinuxagent.common.utils.fileutil.read_file',
            return_value="B9F3C233-9913-9F42-8EB3-BA656DF32502")
    @patch('azurelinuxagent.pa.deprovision.get_deprovision_handler')
    def test_is_provisioned_not_deprovisioned_not_signaled(self,
            mock_deprovision, mock_read, mock_isfile):
