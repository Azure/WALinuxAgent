...
{{
    ...
    def test_extension_upgrade_failure_when_update_fails(self, patch_get_update_command, *args):
        """
        ...
        meaning the new extension is downloaded again and update is called again.
        """
