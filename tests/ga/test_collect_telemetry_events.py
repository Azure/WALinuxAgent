...
from azurelinuxagent.ga.collect_telemetry_events import ExtensionEventSchema, ProcessExtensionEventsPeriodicOperation
...
class TestExtensionTelemetryHandler(AgentTestCase, HttpRequestPredicates):
    ...
    def _create_extension_telemetry_processor(self, telemetry_handler=None):
        ...
        extension_telemetry_processor = ProcessExtensionEventsPeriodicOperation(telemetry_handler)
