...
class TestSendTelemetryEventsHandler(AgentTestCase, HttpRequestPredicates):
    ...
    def _create_send_telemetry_events_handler(self, timeout=0.5, start_thread=True, batching_queue_limit=1, telemetry_api_call_limit=50, telemetry_max_retries=1):
