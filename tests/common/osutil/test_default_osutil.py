...
class DefaultOsUtilTestCase(AgentTestCase):
    ...
    def setUp(self):
        ...
        self.mock_base_cgroups = patch(
            "azurelinuxagent.common.osutil.default.BASE_CGROUPS",
    ...
    def test_mount_cgroups_should_mount_the_cpu_and_memory_controllers(self):
        # the mount command requires root privileges; make it a no op and check
        ...
        with patch("azurelinuxagent.common.osutil.default.shellutil.run_get_output", side_effect=mock_run_get_output) as patch_run_get_output:
            ...
            # the cgroup filesystem and the cpu and memory controllers should
            # have been mounted
    ...
    def test_mount_cgroups_should_handle_errors_when_mounting_an_individual_controller(
        ...
        with patch("azurelinuxagent.common.osutil.default.shellutil.run_get_output", side_effect=mock_run_get_output) as patch_run_get_output:
            with patch("azurelinuxagent.common.cgroupconfigurator.logger.warn") as mock_logger_warn:
                ...
                # the cgroup filesystem and the cpu controller should still
                # have been mounted
                mount_commands = DefaultOsUtilTestCase._get_mount_commands(
                    patch_run_get_output)
