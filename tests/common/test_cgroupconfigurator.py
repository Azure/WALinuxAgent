...
class CGroupConfiguratorTestCase(AgentTestCase):
    ...
    def setUpClass(cls):
        ...
        # Use the file system implementation of CGroupsApi
        # (FileSystemCgroupsApi)
        ...
        # Mounting the cgroup filesystem requires root privileges. Since these
        # tests do not perform any actual operation on cgroups, make it a noop.
    ...
    def setUp(self):
        ...
        # force get_instance() to create a new instance for each test
        ...
        self.mock_cgroups_file_system_root = patch(
    ...
    def test_cgroup_operations_should_not_invoke_the_cgroup_api_when_cgroups_are_not_enabled(
        ...
        # List of operations to test, and the functions to mock used in order
        # to do verifications
        operations = [
            [
                lambda: configurator.create_agent_cgroups(
                    track_cgroups=False),
                "azurelinuxagent.common.cgroupapi.FileSystemCgroupsApi.create_agent_cgroups"],
            [lambda: configurator.cleanup_old_cgroups(
            ), "azurelinuxagent.common.cgroupapi.FileSystemCgroupsApi.cleanup_old_cgroups"],
            ...
            [lambda: configurator.create_extension_cgroups(
                "A.B.C-1.0.0"), "azurelinuxagent.common.cgroupapi.FileSystemCgroupsApi.create_extension_cgroups"],
            [lambda: configurator.remove_extension_cgroups(
                "A.B.C-1.0.0"), "azurelinuxagent.common.cgroupapi.FileSystemCgroupsApi.remove_extension_cgroups"]
        ]
    ...
    def test_cgroup_operations_should_log_a_warning_when_the_cgroup_api_raises_an_exception(
        ...
        # List of operations to test, and the functions to mock in order to
        # raise exceptions
        operations = [
            [
                lambda: configurator.create_agent_cgroups(
