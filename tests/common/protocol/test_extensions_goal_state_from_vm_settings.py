...
class ExtensionsGoalStateFromVmSettingsTestCase(AgentTestCase):
    ...
    def test_it_should_handle_invalid_agent_family_version_to_signature_mappings(self):
        ...
        # The Test family has 5 GASignature elements, one missing the EncodedSignature element, one missing the
        # Version element, one missing both elements, and several more where the value types are not strings.
        # {
        #     "name": "Test",
        #     ...
        #     "versionToSignatureMappings": [
        ...
        #         },
        #         {
        #             "encodedSignature": "test_test_signature_for_invalid"
        #         },
        #         {},
        #         {
        #             "version": 1.0,
        ...
        #         {
        #             "version": 123456,
        #             "encodedSignature": 1.0
        #         },
        #         {
        #             "version": true,
        #             "encodedSignature": 123456
        #         }
        data_file = wire_protocol_data.DATA_FILE_VM_SETTINGS.copy()
