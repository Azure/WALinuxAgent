...
class ExtensionsGoalStateFromExtensionsConfigTestCase(AgentTestCase):
    ...
    def test_it_should_use_default_values_when_in_vm_metadata_is_missing(self):
        with mock_wire_protocol(mockwiredata.DATA_FILE) as protocol:
            extensions_goal_state = protocol.get_extensions_goal_state()
            self.assertEqual("00000000-0000-0000-0000-000000000000", extensions_goal_state.activity_id, "Incorrect activity Id")
            self.assertEqual("00000000-0000-0000-0000-000000000000", extensions_goal_state.correlation_id, "Incorrect correlation Id")
